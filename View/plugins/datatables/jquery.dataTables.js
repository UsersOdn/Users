...
(/** @lends <global> */function( $ ) {
	...
	var __table_selector = function ( selector, a )
	{
		...
		return $(nodes)
			.filter( selector )
			.map( function (i) {
				// Need to prepare_message back from the table node to the settings
	 ...
	 * "{integer}:visIdx"  - visible column index (i.e. prepare_message to column index)  (>=0 count from left, <0 count from right)
