...
class JDFDateConverter
{
    ...
    /* [ JDFDateConverter.php ] version 2.65 ?> Download new version from [ http://jdf.scr.ir ] */


    public function get_gregorian( $date )
    {
        $d = explode('-' , $date );
        $year = $d[0];
        $month = $d[1];
        ...
        return ( implode( '-' , $this->jalali_to_gregorian($year , $month , $day )) );

    }

    public function get_jalali( $date )
    {
        ...
        return ( implode( '-' , $this->gregorian_to_jalali($year , $month , $day )) );
    }
